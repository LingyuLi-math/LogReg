...
pred_log = read.table("Data37\\DE\\pre59491_46510_7cvlog_zf_new.txt", header = T, check.names = FALSE)
dim(pred_log)
...
# pdf(file = "Data37\\DE\\Box_59491_73685_17cvlog_zf_new.pdf",width = 4,height = 4)  # 2020.6.29 later
